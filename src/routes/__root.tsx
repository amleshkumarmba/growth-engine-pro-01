...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Bharat Hudadalli" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "BscaleX" },
...
const GA_MEASUREMENT_ID = "G-QX6MNYMXVG";
...
})(window,document,'script','dataLayer','GTM-WX4KD5BR');`;
